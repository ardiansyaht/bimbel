...
$sqlGetUser = "SELECT email, username, name, sekolah, photo_path, password FROM tb_login WHERE email = ?";
...
if ($resultGetUser) {
    ...
    $sekolah = isset($userData['sekolah']) ? $userData['sekolah'] : '';
        ...
        if (!preg_match('/^(?=.*[A-Z])(?=.*[a-z])(?=.*\d)(?=.*[^\da-zA-Z]).{8,}$/', $newPassword)) {
            ...
            if (password_verify($currentPassword, $userData['password'])) {
                ...
                if ($newPassword == $confirmNewPassword) {
                    ...
                    $updatePasswordQuery = "UPDATE tb_login SET password=? WHERE email=?";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST["save_changes"])) {
        ...
        if ((!empty($name) && !isValidLength($name, 4)) || (!empty($sekolah) && !isValidLength($sekolah, 4)) || (!empty($username) && !isValidLength($username, 4))) {
        ...
        if (!empty($sekolah) && !isValidsekolah($sekolah)) {
            $_SESSION['notification'] = "Invalid sekolah name. Harap pastikan hanya berisi huruf, angka, dan titik.";
            header("Location: " . $_SERVER['PHP_SELF']);
            exit();
        }
        ...
        $updateQuery = "UPDATE tb_login SET name=?, sekolah=?, username=? WHERE email=?";
        $stmt = mysqli_prepare($koneksi, $updateQuery);
        mysqli_stmt_bind_param($stmt, "ssss", $name, $sekolah, $username, $email);
            ...
            if (!empty($_FILES['profile_photo']['name'])) {
                ...
                if ($uploadOk == 0) {
                    ...
                    if (move_uploaded_file($_FILES['profile_photo']['tmp_name'], $targetFile)) {
                        ...
                        $photoUpdateQuery = "UPDATE tb_login SET photo_path=? WHERE email=?";
        ...
        $resetPhotoQuery = "UPDATE tb_login SET photo_path=NULL WHERE email=?";
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade active show" id="account-general">
                            ...
                            <div class="card-body media align-items-center">
                                <!-- General Tab Content -->
                                <img src="<?php echo !empty($userData['photo_path']) ? $userData['photo_path'] : 'https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_1280.png'; ?>" alt class="d-block ui-w-80">
                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" action="">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control mb-1" id="usernameField" name="username" value="<?php echo htmlspecialchars($username, ENT_QUOTES, 'UTF-8'); ?>" readonly>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="sekolah" value="<?php echo $sekolah; ?>">
                                    </div>
